...
'use strict';
 ...
 var questions = [
      ...
      { question : "There's no right or wrong answer, but if you could be anywhere in the world right now, where would you be? ", tags : ["personal"] },
...
exports.handler = function (event, context) {
    try {
       ...
       */
        ...
        if (event.session.application.applicationId !== "amzn1.ask.skill.c9ab158b-cffe-4466-8936-d590e08a45de") {
...
function onIntent(intentRequest, session, callback) {
    ...
    if ("SimpleQuestionIntent" === intentName) {
        ...
        handleQuestionRequest(intent, session, callback);
    } else if ("CompanyTypeQuestionIntent" === intentName) {
        handleQuestionRequest(intent, session, callback);
    } else {
